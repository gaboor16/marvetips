...
@section('contenido')
    <div class="md:flex md:items-center">
        ...
        <div class="md:w-1/2 p-10 md:items-center bg-white  rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{ route('posts.store') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="titulo" name="titulo" placeholder="Tu titulo" type="text" value="{{ old('name') }}"
                ...
                <input type="submit" value="Crear publicación"
                    class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer 
                        uppercase font-bold w-full p-3 text-white roundend-lg">
